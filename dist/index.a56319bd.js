...
})({"4P6y2":[function(require,module,exports) {
...
var _testScroll = require("./animaties/testScroll");
var _testScrollDefault = parcelHelpers.interopDefault(_testScroll);
...
},{"gsap":"fPSuC","gsap/ScrollTrigger":"7wnFk","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"99E0I":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _gsap = require("gsap");
...
const testScroll = ()=>{
    ...
    const animate = (opacity, effect)=>{
        (0, _gsap.gsap).to(".hero__subtitle", {
            opacity: opacity,
            duration: 0.1
        });
        const state = (0, _flip.Flip).getState("#scroll--lottie");
        effect();
    ...
    const observer = new IntersectionObserver((entries)=>{
        entries.forEach((entry)=>{
            if (entry.isIntersecting) setLogoInNavBar();
            else setLogoInHero();
        });
    });
// observer.observe(document.querySelector(".projects"));
};
exports.default = testScroll;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","gsap":"fPSuC","gsap/Flip":"iKp6p"}],"iKp6p":[function(require,module,exports) {
/*!
 * Flip 3.11.5
 * https://greensock.com
 *
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["4P6y2","bAabt"], "bAabt", "parcelRequire6728")
